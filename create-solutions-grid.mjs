...
const content = `import * as Icons from "lucide-react";
...
fs.writeFileSync("components/enterprise/SolutionsGrid.tsx", content);
console.log("Created components/enterprise/SolutionsGrid.tsx");
