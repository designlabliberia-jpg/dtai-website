        ...
        <div className="relative mx-auto h-40 w-40 shrink-0 sm:h-48 sm:w-48">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="absolute inset-0 flex items-center justify-center rounded-full bg-white/5"
            >
...
fs.writeFileSync("components/enterprise/SectorSpotlight.tsx", content);
console.log("Created components/enterprise/SectorSpotlight.tsx");
