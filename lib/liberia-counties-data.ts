...
// Population figures are official 2022 LISGIS National Population and Housing
// Census results (Liberia's first fully digital census). Connectivity and
// active-project figures remain illustrative placeholder data pending
// verified sources.
export const liberiaCounties: CountyData[] = [
  {
    ...
    labelY: 379.4,
    population: "178,798",
    populationValue: 178798,
    history:
      "Named for the cape sighted by early Portuguese explorers; home to Lake Piso, Liberia's largest lagoon, and one of the country's oldest coastal settlements.",
  ...
  },
  {
    ...
    labelY: 281.3,
    population: "95,995",
    populationValue: 95995,
    history:
      "Liberia's youngest county, created in 2001 from parts of Lofa, Bomi and Cape Mount; still largely rainforest and among the least connected regions.",
  ...
  },
  {
    ...
    labelY: 136,
    population: "367,376",
    populationValue: 367376,
    history:
      "Known as Liberia's breadbasket, with roughly 71% of households engaged in agriculture per the 2022 census; hit hard during the civil war and Ebola crisis.",
  ...
  },
  {
    ...
    labelY: 403.9,
    population: "621,841",
    populationValue: 621841,
    history:
      "Liberia's iron-ore heartland, home to Mount Nimba and the LAMCO mining operations that once anchored the national economy.",
  ...
  },
  {
    ...
    labelY: 618.2,
    population: "216,692",
    populationValue: 216692,
    history:
      "Established in 1964 and birthplace of former President Samuel Doe, with deep ties to Liberia's southeastern indigenous heritage.",
  ...
  },
  {
    ...
    labelY: 752.3,
    population: "124,653",
    populationValue: 124653,
    history:
      "Carved from Grand Gedeh in 2000, one of Liberia's newest counties, bordering Cote d'Ivoire.",
  ...
  },
  {
    ...
    labelY: 873,
    population: "172,202",
    populationValue: 172202,
    history:
      "Founded in 1834 by the Maryland State Colonization Society as a separate republic before merging with Liberia in 1857; home to the port city of Harper.",
  ...
  },
  {
    ...
    labelY: 394.8,
    population: "467,502",
    populationValue: 467502,
    history:
      "Named for Bong Mountain and long known for iron-ore mining and Cuttington University, Liberia's oldest private university.",
  ...
  },
  {
    ...
    labelY: 452.3,
    population: "133,668",
    populationValue: 133668,
    history:
      "Formed around the Bomi Hills iron-ore mines that fueled Liberia's mid-20th-century economic boom.",
  ...
  },
  {
    ...
    labelX: 242.4,
    labelY: 508.2,
    population: "1,920,965",
    populationValue: 1920965,
    history:
      "Liberia's political and commercial heart since 1822, when freed African Americans settled Providence Island; home to the capital, Monrovia.",
  ...
  },
  {
    ...
    labelY: 463.6,
    population: "304,946",
    populationValue: 304946,
    history:
      "Created in 1985 from parts of Montserrado and Grand Bassa; home to Roberts International Airport, Liberia's main air gateway.",
  ...
  },
  {
    ...
    labelY: 555.7,
    population: "293,557",
    populationValue: 293557,
    history:
      "One of Liberia's original counties, established in 1839; the port city of Buchanan remains a key export hub.",
  ...
  },
  {
    ...
    labelY: 626.1,
    population: "90,777",
    populationValue: 90777,
    history:
      "Established in 1985, one of Liberia's least populated and most rural counties, largely dependent on subsistence agriculture.",
  ...
  },
  {
    ...
    labelY: 731.5,
    population: "150,358",
    populationValue: 150358,
    history:
      "Founded in 1843 by freed Black settlers from Mississippi; the port city of Greenville was once a thriving 19th-century trade hub.",
  ...
  },
  {
    ...
    labelY: 844.3,
    population: "109,342",
    populationValue: 109342,
    history:
      "Created in 1984, a Kru heartland along the Atlantic coast reflecting Liberia's seafaring Kru ethnic traditions.",
