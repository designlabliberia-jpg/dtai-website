...
const content = `import { Users } from "lucide-react";
...
fs.writeFileSync("components/enterprise/WhoThisIsFor.tsx", content);
console.log("Created components/enterprise/WhoThisIsFor.tsx");
