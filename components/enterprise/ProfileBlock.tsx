        ...
        <div className="grid items-center gap-2 lg:gap-12 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-3 font-primary text-2xl font-bold leading-tight text-neutral-900 sm:text-xl">
              {heading}{headingAccent && <> <span className="text-brand">{headingAccent}</span></>}
            </h2>
            {paragraphs.map((p, i) => (
          ...
          <div className="relative h-[420px]">
            ...
            {collage.secondary && (
              <div className="absolute bottom-2 left-[calc(23%_-_70px)] h-[160px] w-[160px] overflow-hidden rounded-full border-4 border-white shadow-xl bg-white">
                <Image src={collage.secondary.src} alt={collage.secondary.alt} fill sizes="120px" className="object-contain" />
              </div>
            )}
          </div>
        </div>
