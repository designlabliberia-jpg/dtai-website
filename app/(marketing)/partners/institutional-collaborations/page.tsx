...
export const metadata = createPageMetadata(
  ...
  "Institutional partners and development organizations DTAI works alongside."
);
import { PartnersNav } from "@/components/enterprise/PartnersNav";
import { Container } from "@/components/layout/Container";

export default function PartnersCategoryPage() {
  const category = getPartnerCategoryBySlug("institutional-collaborations")!;

  return (
    <section className="bg-white py-24">
      <Container>
        <div className="grid gap-12 lg:grid-cols-[240px_1fr]">
          <PartnersNav activeSlug="institutional-collaborations" />
